      ...
      bucket: {
        actions: {
          ...
          exists: {
            ...
            http: [{ verb: 'get', path: '/exists/:bucketRegion/:bucketName' }],
          },
          setPolicy: {
            handler: bucketController.setPolicy.bind(bucketController),
            http: [{ verb: 'post', path: '/set-policy/:bucketRegion/:bucketName' }],
          },
          enablePublicAccess: {
            handler: bucketController.enablePublicAccess.bind(bucketController),
            http: [{ verb: 'post', path: '/public-access/:bucketRegion/:bucketName' }],
          },
        },
      },
      file: {
        actions: {
          ...
          getFilesKeys: {
            ...
            http: [{ verb: 'get', path: '/list-keys/:bucketRegion/:bucketName' }],
          },
        },
      },
      upload: {
