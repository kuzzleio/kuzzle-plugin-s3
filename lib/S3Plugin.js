...
class S3Plugin {
  constructor () {
    ...
    this.routes = [
      // Upload controller
      { verb: 'get', url: '/upload', controller: 'upload', action: 'uploadGetUrl' },
      { verb: 'put', url: '/upload/:fileKey', controller: 'upload', action: 'uploadValidate' },
      // File controller
      { verb: 'get', url: '/files/:fileKey', controller: 'file', action: 'fileGetUrl' },
      { verb: 'delete', url: '/files/:fileKey', controller: 'file', action: 'fileDelete' }
    ];
  }
