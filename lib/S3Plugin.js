      ...
      file: {
        actions: {
          ...
          fileDelete: {
            ...
            http: [{ verb: 'delete', path: '/_file/delete/:bucketRegion/:bucketName/:fileKey' }],
          },
          getFilesKeys: {
      ...
      upload: {
        actions: {
          getUrl: {
            ...
            http: [{ verb: 'get', path: '/_upload/get-url/:bucketRegion/:bucketName/:uploadDir/:filename' }],
          },
          validate: {
            handler: uploadController.validate.bind(uploadController),
            http: [{ verb: 'post', path: '/_upload/validate/:bucketRegion/:bucketName/:fileKey' }],
          },
        },
      },
    };
