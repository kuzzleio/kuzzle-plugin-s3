...
class BaseController {
  ...
  _getCredentials(targetRegion) {
    ...
    const accessKeyId = getProperty(this.context.secrets, endpointConfig.accessKeyIdPath);
    const secretAccessKey = getProperty(this.context.secrets, endpointConfig.secretAccessKeyPath);
